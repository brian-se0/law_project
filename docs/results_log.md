...
- Re-ran the same 2020-2021 validation slice after the bridge change. The builder now matches all 4 requested symbols, including 3 historical fallback matches for `XLNX`, `VAR`, and `FLIR`.
