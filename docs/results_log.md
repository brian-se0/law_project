...
This is now a substantive single-case empirical result rather than only a reproducibility milestone. Final release sign-off on 2026-04-05: the packaged assessment bundle at `dist/mdvn_assessment_package_2026-04-05.zip`, the paper draft, the bibliography, and the generated MDVN case-study outputs were refreshed together and synchronized to the current `HEAD` commit stamped in the bundle `PACKAGE_README.md`.
